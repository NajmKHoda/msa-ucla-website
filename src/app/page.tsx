...
export default async function Home() {
    ...
    return (
        <>
            <section className='flex flex-col h-[60vh] px-6 justify-center items-center bg-cover bg-fixed' style={{
                backgroundImage: 'linear-gradient(0deg, rgba(0, 0, 0, 0.68) 0%, rgba(0, 0, 0, 0.68) 100%), url(/images/eyecatcher.jpg)',
                backgroundPosition: '50% 50%'
            }}>
                <h1 className='text-4xl sm:text-5xl md:text-6xl text-center font-bold text-msa-yellow'>Muslim Student Association at UCLA</h1>
                <TextCarousel
                    className='text-3xl sm:text-4xl text-center font-semibold text-text-secondary no-wrap'
                    texts={['Assalamualaikum!', '!السلام علیکم', 'अस्सलामु अलैकुम!', 'Esselâmü aleyküm!']} />
            </section>
