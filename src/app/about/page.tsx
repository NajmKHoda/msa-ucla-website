    ...
    return (
        <>
            <div className='h-[50vh] max-h-[450px]' style={{
                background: 'url(images/banners/about/top.jpeg) lightgray no-repeat',
            ...
            <div className='flex flex-col items-stretch gap-0 md:gap-8 px-0 md:px-6 mb-6'>
                <AboutSection title='FAITH' imageUrl='/images/banners/about/faith.jpeg'>
                ...
                <AboutSection title='COMMUNITY' imageUrl='/images/banners/about/community.jpeg' reversed backgroundPosition='50% 30%'>
                ...
                <AboutSection title='EMPOWERMENT' imageUrl='/images/banners/about/empowerment.jpeg' backgroundPosition='50% 35%'>
